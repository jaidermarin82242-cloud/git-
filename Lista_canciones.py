#Se necesitan:
#cancion:
#que tenga nombre de cancion y duracion
#reproductor:
#que tenga una lista de canciones, cancion actual y sus acciones.
#reproducir, siguiente, anterior y mostrar menu de canciones.
...
while True:
    ...
    if opcion == "1":
        ...
        reproductor.agregar_cancion(nombre, duracion)
